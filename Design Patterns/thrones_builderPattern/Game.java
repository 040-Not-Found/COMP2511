...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        Character dragon = new Dragon(1, 1);
        characters.add(dragon);
        Character queen = new Queen(1, 2);
        characters.add(queen);

        queen = new WithChestPlateCap(queen);

        queen.makeMove(1, 3, characters);
        queen.makeMove(1, 8, characters);
